...
<br> - Go to: *Hardware* > *Add Devices* > *Wireless Devices Auto learn*/*Scan QR code or add devices manually* (by entering serial number).
...
<br> - Go to: *Hardware* > *WV2M* > enter the necessary details > *Save*. 

4.	Install the valve inline on the liquid supply line.
<br> Inbuilt Status Indications:
<br>- Green – valve opening
<br>- Red – valve closing/reset to default
<br>- Blue – Not paired with the console/ lost communication with the console, about one minute.
