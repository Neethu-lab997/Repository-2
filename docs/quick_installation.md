...
•	Bring the magnet close to the top of the Valve Driver and move it away three times within eight seconds. For details, see the Turning On and Mounting section.
...
NOTE: If the device is paired by scanning the QR code or entering the serial number before power-up, it appears as Pending in the BlueEye application. The device status in BlueEye changes to Online after power-up.
